...
Wersja `1.2.0` dodaje zakładkę **Encje sterowania**, skan i Test aktualnego stanu oraz sterowanie wybranymi nastawami przez MQTT. Mapa 119 encji pochodzi z profilu Sunsynk `three_phase_lv`. Szczegóły: [Encje sterowania](CONTROL_ENTITIES.md).
