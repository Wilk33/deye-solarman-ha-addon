...
Wersja `0.3.6` domyslnie pobiera dane MQTT z Home Assistant Supervisor, tak jak referencyjny dodatek Sunsynk/Deye Inverter add-on (multi), oraz poprawnie obsluguje opakowana odpowiedz API Supervisora. Dodaje tez panel Ingress Home Assistant do skanowania katalogu bezpiecznych, tylko do odczytu rejestrow telemetrycznych dla rodziny Deye SUN-*-SG04LP3 / SG05LP3. Wynik skanu nie tworzy automatycznie encji MQTT. Uzytkownik wybiera interesujace pozycje w panelu, bez pracy w terminalu.
