...
Wersja `0.6.0` samoczynnie odtwarza zamknieta sesje Solarman TCP, publikuje temperatury w standardowej jednostce Home Assistant `°C`, synchronizuje panel Ingress z motywem Home Assistant, pokazuje HEX i ASCII oraz pobiera aktualizowalny katalog rejestrow z GitHub z lokalnym cache. Wynik skanu nie tworzy automatycznie encji MQTT. Uzytkownik wybiera interesujace pozycje w panelu, bez pracy w terminalu.
