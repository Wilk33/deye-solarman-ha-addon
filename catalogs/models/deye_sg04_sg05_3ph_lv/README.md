# Deye SG04LP3 and SG05LP3 Three-Phase LV - SolarMan Diagnostics 2.0.0
...
`catalog-index.yaml` declares revision 2.0.0, transport compatibility and SHA-256 checksums. The packaging tool also generates the compatible single-file telemetry catalog at `../../../../deye-solarman-diagnostics/deye_sg04_sg05_3ph_lv_catalog.yaml` from these sources.
